...
<head>
    ...
    <meta name="keywords"
        content="Corteclick, peluquerías, barberías, reserva online, citas, agenda, belleza, cabello, servicios de peluquería, búsqueda de peluquerías, precios peluquerías, disponibilidad peluquerías, valoración peluquerías, digitalización peluquerías, reserva de citas online">
    ...
    {{-- Meta adicional para la landing page --}}
    @yield('meta')
...
<body>
    ...
    {{-- Scripts generales o específicos para la landing page --}}
